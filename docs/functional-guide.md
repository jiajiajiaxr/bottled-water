...
- 实时事件：`backend/app/services/realtime/event_bus.py`
...
- Agent 执行循环：`backend/app/services/agents/tool_loop.py`
- 编排入口：`backend/app/services/chat/orchestrator.py`
...
- 工作流执行：`backend/app/services/chat/orchestrator.py`
...
- 后端运行态：`backend/app/services/chat/orchestrator.py`
...
- 工具箱：`backend/app/services/tools/registry.py`
- Agent 执行：`backend/app/services/agents/tool_loop.py`
...
- Agent 选择 Skill：`backend/app/services/agents/tool_loop.py`
