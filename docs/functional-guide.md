...
- Agent 执行循环：`backend/src/app/services/agentic_runtime.py`
...
- 工作流执行：`backend/src/app/services/runtime_service.py`、`backend/src/agent_runtime/`
...
- 后端运行态：`backend/src/app/services/runtime_service.py`、`backend/src/agent_runtime/`
...
- 文件解析和生成：`backend/src/app/services/file_tools.py`
...
- 导出实现：`backend/src/app/services/artifact_exports.py`
- 文件生成工具：`backend/src/app/services/file_tools.py`
...
- 工具箱：`backend/src/app/services/tool_registry.py`
- Agent 执行：`backend/src/app/services/agentic_runtime.py`
...
- Agent 选择 Skill：`backend/src/app/services/agentic_runtime.py`
...
- 运行时：`backend/src/app/services/mcp_runtime.py`
...
- 工具注册与调用：`backend/src/app/services/tool_registry.py`
