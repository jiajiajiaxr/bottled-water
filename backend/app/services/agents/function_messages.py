...
def agent_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "blocks 可用 paragraph、heading、list、table、callout、quote、image、divider、page_break、risk_item、action_plan、summary、conclusion。\n"
        "如果用户只说生成报告/方案/周报/实验报告/项目计划/PRD/会议纪要，请自动选择 report、proposal、weekly、lab_report、project_plan、prd、meeting 模板，并补齐封面、摘要、目录、章节、风险项、行动计划和结论。\n"
