...
function messageAttachments(message: ChatMessage): MessageAttachment[] {
...
function stripInternalAgentOutput(raw: string) {
...
function isLikelyArtifactRequest(text: string) {
