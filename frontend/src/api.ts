...
export const api = {
  ...
  async saveConversationWorkflow(
    conversationId: string,
  ...
  async generateConversationWorkflow(
    conversationId: string,
    instruction?: string,
  ): Promise<ConversationWorkflow> {
    return await request<ConversationWorkflow>(
  ...
  async importMcpAsSkill(payload: {
    workspace_id?: string;
